...
void Automaton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Automaton::setGrammar)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Automaton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Automaton::setStack)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Automaton::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Automaton::setTable)) {
                *result = 2;
                return;
            }
        }
        ...
        {
            typedef void (Automaton::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Automaton::selectStackRow)) {
                *result = 4;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Automaton::selectCell)) {
                *result = 5;
                return;
            }
        }
